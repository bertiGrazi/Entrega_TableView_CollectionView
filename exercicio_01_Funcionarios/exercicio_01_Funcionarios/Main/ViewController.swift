...
extension ViewController: UITableViewDelegate {
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        if let viewController = UIStoryboard(name: "FuncDetail", bundle: nil).instantiateInitialViewController() as? FuncDetailViewController{
            viewController.nome = arrayFuncionarios[indexPath.row].nome
            viewController.imagem = arrayFuncionarios[indexPath.row].imagem
